...
import mobile_icon from '../../public/images/smartphone.png'
import name_icon from '../../public/images/id-card.png'
    ...
    <div className='reg_auth'>
        <div className='form-box'>
            <div className='buttonbox'>
                <div id='btn'></div>
                <button type='button' className='toggle-btn'><Link to="/login" className='login_btn'>LOGIN</Link></button>
                <button type='button' className='toggle-btn'><Link to="/register" className="register_btn">REGISTER</Link></button>
            </div>
        </div>
        ...
        <form className='reg-input-group'>
            ...
            <div>
                <button type='submit' className='submit-btn'> <Link to="/login" className='submit_btn_register'>REGISTER</Link></button>
                <div>
                    <div id='arro'></div>  
