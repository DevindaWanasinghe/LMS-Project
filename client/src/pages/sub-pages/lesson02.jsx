  ...
  <>
    ...
    <div>
        <div className='btn-box'>
            <button className='btn'>System Development Life Cycle</button>

              <div className='num-box-01'>
                <button className='num_btn-01'>02</button>
              </div>
        </div>
    </div> 
    <div>
    ...
    <div className='topic-num-box'>
        <button className='topic-num-btn'>02.1</button>
        <button className='topic-num-btn'>02.2</button>
        <button className='topic-num-btn'>02.3</button>
        <button className='topic-num-btn'>02.4</button>
        <button className='topic-num-btn'>02.5</button>
        <button className='topic-num-btn'>02.6</button>
        <button className='topic-num-btn'>02.7</button>
        <button className='topic-num-btn'>02.8</button>
        <button className='topic-num-btn'>02.9</button>
        <button className='topic-num-btn'>02.10</button>
    </div> 
