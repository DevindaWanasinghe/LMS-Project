  ...
  <>
    ...
    <div>
        <div className='btn-box'>
            <button className='btn'>Information & communication Technology & Society</button>

              <div className='num-box-01'>
                <button className='num_btn-01'>06</button>
              </div>
        </div>
    </div> 
    <div>
    ...
    <div className='topic-num-box'>
        <button className='topic-num-btn'>06.1</button>
        <button className='topic-num-btn'>06.2</button>
        <button className='topic-num-btn'>06.3</button>
        <button className='topic-num-btn'>06.4</button>
        <button className='topic-num-btn'>06.5</button>
        <button className='topic-num-btn'>06.6</button>
        <button className='topic-num-btn'>06.7</button>
        <button className='topic-num-btn'>06.8</button>
        <button className='topic-num-btn'>06.9</button>
        <button className='topic-num-btn'>06.10</button>
    </div> 
